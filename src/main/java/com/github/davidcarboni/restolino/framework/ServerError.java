...
public interface ServerError {
     ...
     * @param requestHandler The details of the endpoint that the error occurred in. This
     ...
     * <code>res</code>.
     * @throws IOException If an error occurs in sending the response. This will
