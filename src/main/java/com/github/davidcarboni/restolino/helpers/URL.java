...
public class URL {
	 ...
	 *             If an error occurs in parsing the URL.
	 */
	 ...
	 * <p>
	 * NB remember that you might need to check for headers such as
	 * "X-Forwarded-For" if you're behind a web server or proxy.
	 * 
	 * @param url
	 *            The ULR to parse.
	 * @throws URISyntaxException
